...
const Details = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-rose-200 to-orange-100 flex w-full px-4 md:px-8 flex-col items-center justify-center">
      <h1 className=' text-3xl py-10'>{mealDetails.strMeal}</h1>
      <img src={mealDetails.strMealThumb} alt="img"className='object-cover h-96 rounded-md' />
